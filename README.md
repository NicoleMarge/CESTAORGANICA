...
- Cuenta de [Supabase](https://supabase.com) para la persistencia en la nube

## 🚀 Configuración e instalación

1. Clona el repositorio:
   ```bash
   git clone https://github.com/NicoleMarge/CESTAORGANICA.git
   ```
2. Abre el proyecto en Android Studio.
3. Crea un proyecto en [Supabase](https://supabase.com) y ejecuta el script `SUPABASE_SCRIPT.sql` incluido en este repositorio para crear las tablas necesarias.
4. Copia la **URL** y la **API Key** de tu proyecto de Supabase y reemplázalas en:
   ```
   app/src/main/java/com/example/huertohogardefinitiveedition/supabase/SupabaseConfig.kt
   ```
5. Sincroniza el proyecto con Gradle y ejecuta la app en un emulador o dispositivo físico.
